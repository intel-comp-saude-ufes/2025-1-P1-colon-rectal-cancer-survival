...
def process_data_file(data_file_csv, base_path, prefix, roc_axes):
    ...
    # Modelo base
    mc = RandomForestClassifier(random_state=42)
...
for data_file in data_files:
    process_data_file(data_file, result_dir, "_randomforest", roc_axes)
...
roc_fig.savefig(f"{result_dir}/curva_roc_cenarios_123_integrados_randomforest.png")
plt.close(roc_fig)
